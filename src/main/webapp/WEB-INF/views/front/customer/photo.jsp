				...
				<div class="s-photo">
					<div class="c-align">
						...
						<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<li class="s-photo__item"><a href="photo-body.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}"
									class="s-photo__link">
										<div class="s-photo__key" align="center">
											<img alt="${board_list.title}" src="<c:url value='${board_list.list_thumnail}'  />">
												 
										</div>
										<div class="s-photo__value" align="center">${board_list.title}</div>
								</a></li>
								</c:forEach>
						</c:otherwise>
					</c:choose>
							...
							<a href="photo.do?board_id=${board_id}&startPage=1&visiblePages=6"
							...
							<a href="photo.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=6"
							...
							<div class="s-news__searchs s-news__searchs--center">
								<div class="s-news__search-boxs">
									<div class="s-news__search-box s-news__search-box-1">
										<div class="s-news__selects">
											<label for="s-news__select" class="is-hidden">포토갤러리 글 검색 선택</label>
								...
								<div class="s-news__search-box s-news__search-box-2">
									<div class="s-news__search">
										<label for="s-news__search" class="s-news__search-label">포토갤러리 글 검색 입력</label>
