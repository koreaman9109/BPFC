					...
					<div class="c-align">
						<div class="c-section">
							<div class="c-box">
								<div class="c-notice2">
									...
									<c:forEach var="file_list" items="${file_list}"  varStatus="status">
											...
											<c:if test="${file_list.extention_name eq '.jpg' ||
												...
												<img style="display: block;" src="resources/board/data/${file_list.file_name2}" alt="${board_detail.title}">
											</c:if>
											</c:if>
									</c:forEach>
									</div>
								...
								<div class="writings">
									...
									<a href="data-body.do?board_id=${preView.board_id}&seq_id=${preView.seq_id}"
									...
									<a href="data-body.do?board_id=${nextView.board_id}&seq_id=${nextView.seq_id}"
						...
						<div class="c-section">
							<div class="c-buttons c-buttons--center">
								<button onclick="location.href='data.do?board_id=9'"
