...
<title>문의하기 사용자 수정 비밀번호 확인</title>
...
$(document).ready(function(){
    ...
    $("#btnLogin").click(function(){
        ...
        // 폼 내부의 데이터를 전송할 주소jquery 로그인 체크
        // 제출
		window.opener.name = "passwordUpdateCheck"; // 부모창의 이름 설정
        document.form1.target = "passwordUpdateCheck"; // 타켓을 부모창으로 설정
        document.form1.action = "passwordUpdateCheck.do";
       ...
       <div class="i-tables">
		...
		<!--        <tr>
		            ...
		            <tr>
		                ...
		                <td>
		                <input type="hidden" name="seq_id" id="seq_id" value="${seq_id}">
