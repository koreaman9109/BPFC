					...
					<div class="c-align">
						<div class="c-section">
							<div class="c-box">
								<div class="c-notice2">
									...
									<div class="c-notice2__box">
										<div class="c-notice2__infos">
											...
											<%-- <div class="c-notice2__info">e-mail : ${board_detail.admin_email}</div> --%>
									...
									<c:forEach var="file_list" items="${file_list}"  varStatus="status">
											...
											<c:if test="${file_list.extention_name eq '.jpg' ||
												...
												<img style="display: block;" src="resources/board/centernews/${file_list.file_name2}" alt="${board_detail.title}">
											</c:if>
											</c:if>
									</c:forEach>
									</div>
								...
								<div class="writings">
									...
									<a href="center-news-body.do?board_id=${preView.board_id}&seq_id=${preView.seq_id}"
									...
									<a href="center-news-body.do?board_id=${nextView.board_id}&seq_id=${nextView.seq_id}"
						...
						<div class="c-section">
							<div class="c-buttons c-buttons--center">
								<button onclick="location.href='center-news.do?board_id=1'"
