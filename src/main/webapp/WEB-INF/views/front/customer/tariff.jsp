					...
					<div class="c-lnb__aligner">
						...
						<ul class="c-lnb__list">
							...
							<li class="c-lnb__item c-lnb__item--active"><a
								href="tariff.do" class="c-lnb__link">화물관리요율</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="breadcrumb">
						<ul class="breadcrumb__list">
							...
							<li class="breadcrumb__item breadcrumb__item-2"><div
								class="breadcrumb__link">화물관리요율</div></li>
						</ul>
					</div>
					<h3 class="c-h2">화물관리요율</h3>
				</div>
			</div>
			<!-- 내용-->
				...
				<div class="s-tariff">
					<div class="c-align">
						<div class="c-sections">
							<div class="c-section">
								<div class="s-tariff__headings">
									<h3 class="s-tariff__heading">장치 경비료</h3>
									<div class="b-ci__button">
										<div class="c-buttons c-buttons--right">
											
											<a href="resources/tariff/화물관리팀-(요율표2).pdf" title="첨부파일 다운로드" download>
												<button class="c-button c-button--green">화물관리요율표 내려받기</button></a>
											</div>
									</div>
									<div class="s-tariff__heading-detail">부두 장치장(창고, 야적장,
										CY)에 장치된 화물에 대하여 징수하는 경비료</div>
										
								</div>
							</div>
							<div class="c-section">
								<h4 class="s-tariff__h4">가. 일반화물</h4>
										...
										<tbody>
											<tr>
												...
												<td rowspan="5" class="s-tariff__table--left">
													...
													<div class="s-tariff__cont">
														<em class="s-tariff__em">종가제(수출품)</em> - 감가 × 요율 × 일수
													</div>
													<div class="s-tariff__cont">
							...
							<div class="c-section">
								<h4 class="s-tariff__h4">나. 컨테이너(종량제)</h4>
								<div class="s-tariff__tables">
									<table class="s-tariff__table">
							...
							<div class="c-section">
								<h4 class="s-tariff__h4">다. 철재류 등(대량 화물)</h4>
								<div class="s-tariff__tables">
									<table class="s-tariff__table">
						...
						<div class="c-sections">
							<div class="c-section">
								<div class="s-tariff__headings">
									<h3 class="s-tariff__heading">하선 경비료</h3>
								...
								<div class="s-tariff__tables">
									<table class="s-tariff__table">
										...
										<tbody>
											...
											<tr>
												<td>최저 경비료</td>
												<td>B/L 당 10,000원 미만은 10,000원 적용</td>
												<td></td>
											</tr>
										</tbody>
									</table>
						...
						<div class="c-sections">
							<div class="c-section">
								<div class="s-tariff__headings">
									<h3 class="s-tariff__heading">일반 경비료</h3>
