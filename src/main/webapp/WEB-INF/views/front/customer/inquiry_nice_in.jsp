...
<%
	...
	String sReturnUrl = "http://www.localhost:8080/interlink/inquiry_nice_text.do"; // 성공시 이동될 URL
	String sErrorUrl = "http://www.localhost:8080/interlink/checkplus_fail.do"; // 실패시 이동될 URL
