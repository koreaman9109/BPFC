				...
				<div class="c-lnb">
					<div class="c-lnb__aligner">
						...
						<ul class="c-lnb__list">
							...
							<li class="c-lnb__item c-lnb__item--active"><a href="data.do?board_id=9"
					...
					<div class="breadcrumb">
						<ul class="breadcrumb__list">
							...
							<li class="breadcrumb__item breadcrumb__item-2"><div
								class="breadcrumb__link">자료실</div></li>
						</ul>
					</div>
					<h3 class="c-h2">자료실</h3>
				</div>
			</div>
			<!-- 내용-->
				...
				<div class="s-news">
					<div class="c-align">
						<div class="s-news__searchs">
							...
							<div class="s-news__search-boxs">
								<div class="s-news__search-box s-news__search-box-1">
									<div class="s-news__selects">
										<label for="s-news__select" class="is-hidden">자료실 글 검색 선택</label>
							...
							<div class="s-news__search-box s-news__search-box-2">
								<div class="s-news__search">
									<label for="s-news__search" class="s-news__search-label">자료실 글 검색 입력</label>
							...
							<div class="c-notice__scroll">
								<table class="c-notice">
                                    ...
                                    ${totalCnt+1-(startpage*10+statuscount)}
											...
											<td class="c-notice__left"><a href="data-body.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}"
						...
						<div class="c-pagination">
							<a href="data.do?board_id=${board_id}&startPage=1&visiblePages=10"
							...
							<a href="data.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=10"
