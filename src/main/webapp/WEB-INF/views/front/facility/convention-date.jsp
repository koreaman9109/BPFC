				...
				<div class="l-depth3">
					<div class="l-depth3__aligner">
						...
						<ul class="l-depth3__list">
							<li class="l-depth3__item"><a href="convention-intro.do"
								class="l-depth3__link">컨벤션 소개</a></li>
							<li class="l-depth3__item l-depth3__item--active"><a
								href="convention-date.do" class="l-depth3__link">컨벤션 일정</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="breadcrumb">
						<ul class="breadcrumb__list">
							...
							<li class="breadcrumb__item breadcrumb__item-3"><div
									class="breadcrumb__link">컨벤션 일정</div></li>
						</ul>
					</div>
			...
			<div class="c-contents">
				<div class="f-convention">
					<div class="f-convention__aligner">
						<h5 class="is-hidden">컨벤션 일정</h5>
						<ul class="c-tabs">
							<li class="c-tab"><a href="convention-intro.do"
								class="c-link">컨벤션 소개</a></li>
							<li class="c-tab c-tab--active"><a href="convention-date.do"
			...
			$(function() {
				...
				$('#calendar').fullCalendar({
									...
									dayClick: function(date, jsEvent, view) {
										location.href = "convention-date.do?con_no="+date.format('YYYY/MM/DD')+"";
									  }
								    });
