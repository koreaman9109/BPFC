	...
	$(document).ready(function() {
						...
						$(document).ready(function() { 
							...
							$("#write").click(function() {
								location.href = "bid_write.do?board_id=" + $("#board_id").val();
							});
						 }); 
						...
						<c:otherwise>
							<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<tr>
									...
									<td>
									<a id="title" class="mouseOverHighlight" onclick="location.href='bid_detail.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}'">${board_list.title}</a>
									</td>
									<c:choose>
