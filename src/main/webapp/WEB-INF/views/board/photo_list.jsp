	...
	$(document).ready(function() {
						...
						$(document).ready(function() { 
							...
							$("#write").click(function() {
								location.href = "photo_write.do?board_id=" + $("#board_id").val();
							});
						 }); 
							    ...
							    if (index == 1) {
									...
									if(confirm("정말로 삭제 하시겠습니까?") == true) {
										if($('input:checkbox[id="checkOne"]').is(":checked") == true)  {
								           document.listForm.action='photoListDelete.do';
												alert("삭제 되었습니다.");
								          } else{
		...
		<div align="center" style="padding-top: 100px; padding-left: 200px; width: auto;">
				...
				<table class="table table-hover">
					<tr class="table-info" align="center">
						...
						<td align="center" width="89px">이미지</td>
						...
						<c:otherwise>
							<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<tr>
                                    ...
                                    ${totalCnt+1-(startpage*5+statuscount)}
                                     </td>
									<td>
									<a name="title" id="title" class="mouseOverHighlight" onclick="location.href='photo_detail.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}'">&nbsp;${board_list.title}</a>
									...
									<%--  <td align="center">
									<input type="button" name="preview" id="${board_list.seq_id}" onclick="location.href='photo_detail.do?seq_id=${board_list.seq_id}'" value="미리보기" />
									</td> --%>
										<td><img style="width: 100px; height: 100px; margin-left: auto; margin-right: auto; display: block;" src="<c:url value='${board_list.list_thumnail}'/>"></td> 		
									</tr>
							</c:forEach>
						</c:otherwise>
					</c:choose>
				...
				<div style="padding-top: 30px;" align="center">
					<table style="width: 900px;">
						<tr>
							...
							<input class="btn btn-primary" type="button" value="게시물 삭제" id="listDelBtn" name="listDelBtn" onclick="detailSubmit(1)" />
				...
				<!-- 페이징 view -->
						<div class="c-pagination" align="center" style="padding-left: 200px; padding-bottom:100px; margin-top:-27px; width: auto;">
							<a href="photo_list.do?board_id=${board_id}&startPage=1&visiblePages=5"
							...
							<a href="photo_list.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=5"
