		...
		<div align="center" style="padding-top: 100px; padding-left: 200px; width: auto;">
				...
				<table style="border: 0; width: 900px;">				
					...
					<select class="selectForm" name="sch_type" id="sch_type" >			
						<option value="title">분실물명</option>
				...
				<table class="table table-hover">
					<tr class="table-info" align="center">
						...
						<td align="center" width="240px">분실물명</td>
						...
						<c:otherwise>
							<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<tr>
									...
									<td>
									<a id="title" class="mouseOverHighlight" onclick="location.href='lost_detail.do?board_id=6&seq_id=${board_list.seq_id}'">&nbsp;${board_list.title}</a>
									</td>
				...
				<!-- 페이징 view -->
						...
						<div class="c-pagination" align="center" style="padding-left: 200px; padding-bottom:100px; margin-top:-27px; width: auto;">
								<a href="lost_list.do?board_id=${board_id}&startPage=1&visiblePages=10"
								...
								<a href="lost_list.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=10"
