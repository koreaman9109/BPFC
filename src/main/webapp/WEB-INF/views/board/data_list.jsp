	...
	$(document).ready(function() {
						...
						$(document).ready(function() { 
							...
							$("#write").click(function() {
								location.href = "data_write.do?board_id=" + $("#board_id").val();
							});
						 }); 
							    ...
							    if (index == 1) {
									...
									if(confirm("정말로 삭제 하시겠습니까?") == true) {
										if($('input:checkbox[id="checkOne"]').is(":checked") == true)  {
								           document.listForm.action='dataListDelete.do';
												alert("삭제 되었습니다.");
								          } else{
...
<!-- 						<td align="center" width="89px">미리보기</td> -->
						...
						<c:otherwise>
							<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<tr>
									...
									<td>
									<a id="title" class="mouseOverHighlight" onclick="location.href='data_detail.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}'">${board_list.title}</a>
									</td>
									<c:choose>
				...
				<!-- 페이징 view -->
						...
						<div class="c-pagination" align="center" style="padding-left: 200px; padding-bottom:100px; margin-top:-27px; width: auto;">
							<a href="data_list.do?board_id=${board_id}&startPage=1&visiblePages=10"
							...
							<a href="data_list.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=10"
