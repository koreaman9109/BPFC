...
$(document).ready(function(){
    ...
    $("#list").click(function() {
		...
		location.href = "data_list.do?board_id=9";
	}else{
		return;
		}
			});
...
function detailSubmit(index) {
			if(confirm("정말로 수정 하시겠습니까?")) {
				...
				// 폼에 입력한 데이터를 서버로 전송
				document.listForm.action='dataBoardUpdate.do';
			...
			<table class="table table-hover" style="margin-bottom: 0;">
				...
				<tr>
					...
					<td colspan="1">
						...
						id="admin_id" name="admin_id" maxlength="10" readonly="readonly" 
				...
				<tr>	
					<td class="table-info">	 
						제목</td>
						<td> <input type="text" style="width: 100%; " id="title" name="title"
						placeholder="제목을 입력해주세요" value="${board_detail.title}" />
					</td>
				</tr>
				</table>
