	...
	$(document).ready(function() {
						...
						$(document).ready(function() { 
							...
							$("#write").click(function() {
								location.href = "newsletter_write.do?board_id=" + $("#board_id").val();
							});
						 }); 
							    ...
							    if (index == 1) {
									...
									if(confirm("정말로 삭제 하시겠습니까?") == true) {
										if($('input:checkbox[id="checkOne"]').is(":checked") == true)  {
								           document.listForm.action='newsletterListDelete.do';
												alert("삭제 되었습니다.");
								          } else{
			...
			<div align="center" style="padding-top: 100px; padding-left: 200px; width: auto;">
				...
				<table style="border: 0; width: 900px">		
					...
					<select class="selectForm" name="sch_type" id="sch_type" >
						...
						<input class="searchForm" type="text" id="sch_value" name="sch_value" value="${sch_value}"/>
				...
				<table class="table table-hover">
					<tr class="table-info" >
						...
						<td align="center" width="90px">등록일자</td>
						...
						<c:otherwise>
							<c:forEach var="board_list" items="${board_list}"  varStatus="status">
								<tr>
									...
									<td>
									<a id="title" class="mouseOverHighlight" onclick="location.href='newsletter_detail.do?board_id=${board_list.board_id}&seq_id=${board_list.seq_id}'">&nbsp;${board_list.title}</a>
									</td>
									<c:choose>
									...
									<%-- <td align="center">
									<input type="button" name="preview" id="${board_list.seq_id}" onclick="location.href='newsletter_detail.do?seq_id=${board_list.seq_id}'" value="미리보기" />
									</td> --%>
										<td><img style="width: 70px; height: 100px; margin-left: auto; margin-right: auto; display: block;" src="<c:url value='${board_list.thumnail}'  />"><td>		
									</tr>
							</c:forEach>
						</c:otherwise>
					</c:choose>
				...
				<!-- 페이징 view -->
						<div class="c-pagination" align="center" style="padding-left: 200px; padding-bottom:100px; margin-top:-27px; width: auto;">
							<a href="newsletter_list.do?board_id=${board_id}&startPage=1&visiblePages=5"
							...
							<a href="newsletter_list.do?board_id=${board_id}&startPage=${totalPage}&visiblePages=5"
