						...
						$("#modify")
								.click(
										function() {
											...
											location.href = "photoBoardUpdateForm.do?board_id=" + $("#board_id").val() + "&seq_id=" + $("#seq_id").val();
											}else{
												return;
											}
													});
	 ...
	 function detailSubmit(index) {
		    if (index == 1) {
				if(confirm("정말로 삭제 하시겠습니까?")) {
					document.listForm.action='photoBoardDelete.do';
					...
					<td>&ensp;${board_detail.hit}</td>
							...
							<tr height="200px">
								...
								<td colspan="2" valign="top">
									<img style="width: 700px; height: 400px;" src="resources/board/photo/${file_list.file_name2}">
								</td>
							</tr>
								</c:if>
							</c:forEach>
