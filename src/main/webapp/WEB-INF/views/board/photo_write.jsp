...
<script type="text/javascript">
	...
	function addbt() {
		...
		$("#addtd").append(
				'<tr><td>' + 
				'<input style="width: 100%;" accept="image/gif, image/jpeg, image/png, image/bmp" type="file" name="uploadfile[' + fileIndex + ']" id="file_up[' + fileIndex + ']"  />' +
				'</td></tr>');
	};
</script>
</head>
<body>
	...
	<div>
		...
		<div align="center" style="padding-top: 100px; padding-left: 200px; width: auto;">
        		<h1>포토갤러리</h1>
		<br>
			<form name="form1" method="post" action="photo_insert.do" enctype="multipart/form-data">
				...
				<table class="table table-hover">
					...
					<tr>
					<td width="100%">
						<input type="file" class="test33"  name="uploadfile[0]" style="width: 100%;" required="required" id="file_up[0]" accept="image/gif, image/jpeg, image/png, image/bmp"/>
					</td>
					<td align="right">
