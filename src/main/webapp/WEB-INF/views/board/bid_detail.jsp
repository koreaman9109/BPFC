			...
			.ready(
					function() {
						...
						$("#list").click(function() {
							...
							location.href = "bid_list.do?board_id=" + $("#board_id").val();
						}); 
						...
						$("#modify")
								.click(
										function() {
											...
											location.href = "bidBoardUpdateForm.do?board_id=" + $("#board_id").val() + "&seq_id=" + $("#seq_id").val();
											}else{
												return;
											}
													});
	 ...
	 function detailSubmit(index) {
		    if (index == 1) {
				if(confirm("정말로 삭제 하시겠습니까?")) {
					document.listForm.action='bidBoardDelete.do';
