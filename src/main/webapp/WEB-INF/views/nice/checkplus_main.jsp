...
<%
	...
	String sReturnUrl = "http://localhost:8080/interlink/checkplus_success.do"; // 성공시 이동될 URL
	String sErrorUrl = "http://localhost:8080/interlink/checkplus_fail.do"; // 실패시 이동될 URL
