...
<body>
	...
	<div align="center"
		...
		<h1>채용관리<!--  <font title="1. 채용관리 리스트상의 번호는 게시판 고유번호가 표기됨으로 번호가 일정하지 않습니다.
	(->CMS페이지에서만 적용됩니다.)
2. 채용게시판의 게시물 개수관련은 우측과 좌측 상단에 카운트 됩니다.
3. 작성일자는 시, 분, 초 까지 기록되며, 이는 CMS 페이지에서만 표기됩니다.
4. 게시판 삭제는 선택 칸 클릭(☑) 후 왼쪽 하단의 선택삭제를 누르면 삭제됩니다.
	(-> 삭제된 게시판은 30일 동안만 보관되며 이후에는 복구가 불가능 합니다.)
5. 채용게시판 등록은 우측 하단의 등록 버튼을 클릭 하면 등록페이지로 이동 됩니다.
6. 페이징 처리는 하단에 첫째 페이지, 각 페이지, 마지막 페이지로 구성되어 있습니다.
			...
			<table class="table table-hover">
				...
				<c:forEach var="boardList" items="${boardList}" varStatus="status">
					<tr id="tdd">
						...
						<td style="text-align:center;"><input type="checkbox" id="check_box" name="all_no"
